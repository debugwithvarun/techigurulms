                            ...
                            {filteredCertificates.map((cert, idx) => (
                                <motion.div key={cert._id} layout
                                    ...
                                    <div className="relative aspect-[16/9] overflow-hidden bg-slate-100">
                                        ...
                                        <img src={getImageUrl(cert.thumbnail) || 'https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=2029&auto=format&fit=crop'}
                                            alt={cert.title}
                                        ...
                                        <div className="absolute top-4 left-4 z-20 flex gap-2">
                                            ...
                                            {isInactiveRoute && (
                                                <span className="bg-slate-900/90 backdrop-blur-md text-white px-3 py-1 rounded-full text-[10px] font-bold shadow-lg uppercase tracking-wider">Archived</span>
                                            )}
                                        </div>
